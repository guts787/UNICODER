...
class CyberDecoder:
    def __init__(self, root):
        ...
        self.root.title("UNICODER v1.0")
        self.root.geometry("1180x880")
        self.root.configure(bg="#030305")
        
        # window branding and icon binding
        try:
        ...
        # registers for handling current stream slice
        ...
        # playback timeline variables
        self.frames = []
        self.current_frame = 0
        self.is_playing = False
        self.fps = 50
        
        # trigger styles setup and build layout
    ...
    def draw_hud(self, canvas_obj, w, h):
        ...
        # technical background raster lines
        ...
        # cyberpunk hardware frame aesthetics
    ...
    def make_btn(self, canvas_obj, btn_w, btn_h, text, cmd, is_main=False):
        # generate clean non-ai tag based on button text string
    ...
    def setup_ui(self):
        ...
        tk.Label(self.tab_enc, text="CONVERT IMAGE TO HEX", bg="#080911", fg="#FFFFFF", font=("Consolas", 12, "bold")).pack(anchor="w", pady=(0, 12), padx=10)
        
        c_b_img = tk.Canvas(self.tab_enc, bg="#080911", width=320, height=44, highlightthickness=0)
        c_b_img.pack(fill="x", pady=(10, 15), padx=10)
        self.make_btn(c_b_img, 320, 44, "🖼️  LOAD & CONVERT IMAGE", self.convert_image_to_hex, True)
        
        tk.Label(self.tab_enc, text="Selected image will be scaled to X/Y bounds", bg="#080911", fg="#547585", font=("Consolas", 9)).pack(anchor="w", padx=10, pady=2)
        tk.Label(self.tab_enc, text="and exported column-by-column into hex data.", bg="#080911", fg="#547585", font=("Consolas", 9)).pack(anchor="w", padx=10, pady=2)
